...
dzenFont       = "xft:Liberation Sans:medium:size=9"
menuFont       = "xft:Liberation Sans:medium:size=11"
...
boxLeftIcon    = "/home/prowler/.xmonad/icons/boxleft.xbm"  --left icon of dzen boxes
boxLeftIcon2   = "/home/prowler/.xmonad/icons/boxleft2.xbm" --left icon2 of dzen boxes
boxRightIcon   = "/home/prowler/.xmonad/icons/boxright.xbm" --right icon of dzen boxes
xDefRes        = 1920 --no longer used
...
myStartupHook =
    ...
    (spawn "feh --bg-scale ~/Pictures/black2_darker.jpg") <+>
    (spawn "urxvtd") <+>
    (spawn "xss-lock -- physlock") <+>
    -- (spawn "compton --config ~/.xmonad/compton.conf -b") <+>
    ...
    (spawn "~/.xmonad/haskell-cpu-usage/haskell-cpu-usage.out 5") <+>
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
    ...
    , ((modMask, xK_Tab), goToSelected $ myGSConfig myColorizer)         --Launch GridSelect
    ...
    , ((mod1Mask .|. controlMask, xK_l), spawn "physlock")               --Launch default terminal

    --Window management bindings
    , ((modMask .|. shiftMask, xK_q), kill)                                   --Close focused window
    ...
    , ((modMask, xK_Left), sendMessage Shrink)                                   --Shrink the master area
    , ((modMask, xK_Right), sendMessage Expand)                                   --Expand the master area
    ...
    , ((modMask, xK_l), sendMessage $ Go R)                               --Change focus to right
    , ((modMask, xK_h), sendMessage $ Go L)                               --Change focus to left
    , ((modMask, xK_k), sendMessage $ Go U)                               --Change focus to up
    , ((modMask, xK_j), sendMessage $ Go D)                               --Change focus to down
    , ((modMask .|. shiftMask, xK_l), sendMessage $ Swap R)             --Swap focused window to right
    , ((modMask .|. shiftMask, xK_h), sendMessage $ Swap L)             --Swap focused window to left
    , ((modMask .|. shiftMask, xK_k), sendMessage $ Swap U)             --Swap focused window to up
    , ((modMask .|. shiftMask, xK_j), sendMessage $ Swap D)             --Swap focused window to down
    , ((modMask .|. controlMask, xK_l), withFocused (keysMoveWindow (30,0))) -- move floated window 10 pixels right
    , ((modMask .|. controlMask, xK_h), withFocused (keysMoveWindow (-30,0))) -- move floated window 10 pixels left
    , ((modMask .|. controlMask, xK_k), withFocused (keysMoveWindow (0,-30)))   -- move floated window 10 pixels up
    , ((modMask .|. controlMask, xK_j), withFocused (keysMoveWindow (0,30)))  -- move floated window 10 pixels down
    ...
    , ((0, xF86XK_AudioMute), spawn "~/.xmonad/scripts/voldzen.sh t -d")                                                   --Mute/unmute volume
    , ((0, xF86XK_AudioRaiseVolume), spawn "~/.xmonad/scripts/voldzen.sh + -d")                                            --Raise volume
    , ((0, xF86XK_AudioLowerVolume), spawn "~/.xmonad/scripts/voldzen.sh - -d")                                            --Lower volume
    , ((0, xF86XK_AudioNext),  flashText myTextConfig 1 " Next Song " >> spawn "ncmpcpp next")                   --Next song
    , ((mod1Mask, xK_Right), flashText myTextConfig 1 " Next Song " >> spawn "ncmpcpp next")
    , ((0, xF86XK_AudioPrev), flashText myTextConfig 1 " Previous Song " >> spawn "ncmpcpp prev")                --Prev song
    , ((mod1Mask, xK_Left), flashText myTextConfig 1 " Previous Song " >> spawn "ncmpcpp prev")
    , ((0, xF86XK_AudioPlay), flashText myTextConfig 1 " Song Toggled " >> spawn "ncmpcpp toggle")               --Toggle song
    , ((mod1Mask .|. controlMask, xK_Down), flashText myTextConfig 1 " Song Toggled " >> spawn "ncmpcpp toggle")
    , ((0, xF86XK_AudioStop), flashText myTextConfig 1 " Song Stopped " >> spawn "ncmpcpp stop")                 --Stop song
    , ((mod1Mask .|. controlMask, xK_Up), flashText myTextConfig 1 " Song Stopped " >> spawn "ncmpcpp stop")
    , ((0, xF86XK_MonBrightnessUp), spawn "~/.xmonad/scripts/bridzen.sh + -d")                                                  --Raise brightness
    , ((0, xF86XK_MonBrightnessDown), spawn "~/.xmonad/scripts/bridzen.sh - -d")                                                --Lower brightness
    , ((0, xF86XK_ScreenSaver), spawn "~/.xmonad/scripts/turnoffscreen.sh")                                                --Lock screen
    , ((0, 0xff14), spawn "~/.xmonad/scripts/turnoffscreen.sh")
    , ((0, xK_Print), spawn "scrot '%Y-%m-%d_$wx$h.png'" >> flashText myTextConfig 1 " Screenshot Saved ")       --Take a screenshot
...
-- Brightness percent
brightPerc :: Double -> Logger
brightPerc p = fileToLogger format "0" "/sys/class/backlight/intel_backlight/actual_brightness" where
    format x = (show . round $ (read x::Double) / p * 100) ++ "%"
